...
const stations = [
  ...
  { id: 'wctrsa', name: 'West Coast Talk Radio (San Adreas)', genre: 'Talk Radio', color: 'bg-blue-400', audio: '5.WCTR (West Coast Talk Radio) (San Andreas).mp3', image: 'WCTRSA.jpg', size: 'small' },
...
const GTARadioDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-black p-8">
      ...
      {/* Add an empty div to create space for the player */}
        ...
        <div className="fixed bottom-0 left-0 right-0 player-gradient text-white p-4">
          <div className="max-w-4xl mx-auto flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              />
              <div>
                <h3 className="text-2xl font-bold station-name-gta neon-text">
            ...
            <div className="flex items-center space-x-6">
              ...
              <button 
                ...
                className="p-3 rounded-full bg-white text-gray-900 hover:bg-gray-200 transition-colors transform hover:scale-110"
              >
